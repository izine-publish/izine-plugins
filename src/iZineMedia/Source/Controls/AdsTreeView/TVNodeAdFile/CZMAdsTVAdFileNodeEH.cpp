//========================================================================================
//	
//	$HeadURL: svn://localhost/izine/iZinePlns/Codebase/trunk/iZineMedia/Source/Controls/AdsTreeView/TVNodeAdFile/CZMAdsTVAdFileNodeEH.cpp $
//	$Revision: 2740 $
...
class ZMAdsTVAdFileNodeEH : public inheritClass
{
public:
						ZMAdsTVAdFileNodeEH(IPMUnknown * boss);
	virtual				~ZMAdsTVAdFileNodeEH();
...
CREATE_PMINTERFACE(ZMAdsTVAdFileNodeEH, kZMAdsTVAdFileNodeEHImpl)

ZMAdsTVAdFileNodeEH::ZMAdsTVAdFileNodeEH(IPMUnknown * boss)
: inheritClass(boss)
...
// Destructor
//----------------------------------------------------------------------------------------
ZMAdsTVAdFileNodeEH::~ZMAdsTVAdFileNodeEH()
{
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::Deactivate(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16 
ZMAdsTVAdFileNodeEH::ButtonDblClk(
	IEvent* e)
{
	LogFunctionEnterExit;
	...
	selfSubject->Change( kZMUIAdsTV_AdFileNodeDoubleClickPressedMsg, IEventHandler::kDefaultIID, e );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::ButtonTrplClk(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::ButtonQuadClk(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::ButtonQuintClk(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::MouseWheel(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::ControlCmd(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::GetKeyFocus(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::GiveUpKeyFocus(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::WillingToGiveUpKeyFocus()
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::SuspendKeyFocus()
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::ResumeKeyFocus()
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::CanHaveKeyFocus()const
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::WantsTabKeyFocus() const
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::PlatformEvent(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
 ...
 */
bool16
ZMAdsTVAdFileNodeEH::CallSysEventHandler(
	IEvent* e)
{
	LogFunctionEnterExit;
	InterfacePtr<IEventHandler> orgImpl( this, mDelegateIID );
