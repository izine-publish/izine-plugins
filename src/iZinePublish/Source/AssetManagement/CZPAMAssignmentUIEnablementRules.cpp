//========================================================================================
//	
//	$HeadURL: svn://localhost/izine/iZinePlns/Codebase/trunk/iZinePublish/Source/AssetManagement/CZPAMAssignmentUIEnablementRules.cpp $
//	$Revision: 4088 $
...
class CZPAMAssignmentUIEnablementRules : public inheritClass
{
public:
						CZPAMAssignmentUIEnablementRules(IPMUnknown * boss);
	virtual				~CZPAMAssignmentUIEnablementRules();
...
CREATE_PMINTERFACE(CZPAMAssignmentUIEnablementRules, kZPAMAssignmentUIEnablementRulesImpl)

CZPAMAssignmentUIEnablementRules::CZPAMAssignmentUIEnablementRules(IPMUnknown * boss)
: inheritClass(boss)
{
...
// Destructor
//----------------------------------------------------------------------------------------
CZPAMAssignmentUIEnablementRules::~CZPAMAssignmentUIEnablementRules()
{
...
#if defined(InDnCS5) || defined(InDnCS5_5)
bool16
CZPAMAssignmentUIEnablementRules::IsCommandEnabled(
	int32						commandID,
	UIDRef						assetRef,
	UIDRef						itemRef)
#else
