//========================================================================================
//	
//	$HeadURL: svn://localhost/izine/iZinePlns/Codebase/trunk/iZinePublishUI/Source/ActionComponent/CZPAMAddAllStoriesToAssignmentActionComponent.cpp $
//	$Revision: 4088 $
...
class CZPAMAddAllStoriesToAssignmentActionComponent : public inheritClass
{
public:
						CZPAMAddAllStoriesToAssignmentActionComponent(IPMUnknown * boss);
	virtual				~CZPAMAddAllStoriesToAssignmentActionComponent();
...
CREATE_PMINTERFACE(CZPAMAddAllStoriesToAssignmentActionComponent, kZPAMAddAllStoriesToAssignmentActionComponentImpl)

CZPAMAddAllStoriesToAssignmentActionComponent::CZPAMAddAllStoriesToAssignmentActionComponent(IPMUnknown * boss)
: inheritClass(boss)
...
// Destructor
//----------------------------------------------------------------------------------------
CZPAMAddAllStoriesToAssignmentActionComponent::~CZPAMAddAllStoriesToAssignmentActionComponent()
{
...
//----------------------------------------------------------------------------------------
void
CZPAMAddAllStoriesToAssignmentActionComponent::UpdateActionStates(
...
//----------------------------------------------------------------------------------------
void
CZPAMAddAllStoriesToAssignmentActionComponent::DoAction(
	IActiveContext* ac, ActionID inActionID, GSysPoint mousePoint, IPMUnknown* widget)
{
	...
	if( inActionID == kSLAddAllStoriesToNewAssignmentActionID 
	|| ( inActionID > kSLAddAllStoriesToAssignmentDynamicActionID && inActionID <= kSLAddAllStoriesToAssignmentDynamicEndActionID ) )
	{
		do
		{
			if( !isLoggedIn )
			...
			bool isNewAssignmentActionID = (inActionID == kSLAddAllStoriesToNewAssignmentActionID);
			...
			if( isNewAssignmentActionID )
			{
				...
				dynamicMenu->RebuildMenu(kSLAddAllStoriesToAssignmentDynamicActionID, nil);
				...
				const ActionID startActionID = kSLAddAllStoriesToAssignmentDynamicActionID + 1;
				const ActionID endActionID = kSLAddAllStoriesToAssignmentDynamicEndActionID;
...
//----------------------------------------------------------------------------------------
void
CZPAMAddAllStoriesToAssignmentActionComponent::DoAction_Default(
